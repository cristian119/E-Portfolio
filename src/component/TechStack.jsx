    ...
    <div className="w-full flex flex-col items-center">
      <Fade triggerOnce={true} duration={3000}>
        <div className="text-white text-4xl mt-20 mb-4 text-center space-mono-regular z-10">
          <span>Tech-Stack</span> {/* Use span or div instead of nested Fade */}
        </div>
      </Fade>
      <Fade triggerOnce={true} duration={3000}>
        <div className="grid grid-cols-3 xs:gap-4 xs:w-fit gap-11 mt-4 space-mono-regular">
          {[
            ...
            <div key={index} className="flex flex-col items-center group">
              ...
              />
              <span className="text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 mt-2 text-sm">
                {tech.alt}
              </span>
            </div>
          ))}
